...
| `SESSION_SECRET`              | **Required in production** (and whenever `AUTH_ENABLED=true`). ≥32 characters. HMAC key for signed sessions. Server **exits on start** if missing or too short.                                |
